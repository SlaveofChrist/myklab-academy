 ...
 * référent, prix. Cliquer sur la carte mène à la page détail (chapitres + quiz).
 */
function CoursCard({ cours }) {
  return (
    <Link to={`/cours/${cours.id_cours}`}>
      <Card className="p-5 flex flex-col h-full hover:shadow-md hover:border-brand-orange/40 transition-shadow cursor-pointer">
